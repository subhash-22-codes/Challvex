    ...
    <main className="max-w-[1400px] mx-auto px-6 py-12 lg:py-20">
      <section className="mb-12">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-10">
          <header className="space-y-1">
            ...
            <p className="text-[11px] text-zinc-500 max-w-sm leading-relaxed italic">
              {currentOrg 
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-px bg-zinc-800 border border-zinc-800">
            {[
              ...
              <div key={stat.label} className="bg-[#09090b] px-5 py-3 min-w-[120px]">
                <p className="text-[10px] text-zinc-500 font-medium tracking-tight uppercase">{stat.label}</p>
      ...
      <section className="mb-10">
        <div className="flex flex-col md:flex-row gap-px bg-zinc-800 border border-zinc-800">
          <div className="flex-1 bg-[#09090b] flex items-center px-4 focus-within:bg-zinc-900/50 transition-colors">
            ...
            <input
              ...
              className="w-full h-11 bg-transparent text-[11px] text-zinc-200 placeholder:text-zinc-600 outline-none"
            />
          </div>
          ...
          <div className="flex items-center gap-6">
            {[
              ...
              <button
                ...
                className={`text-[11px] font-semibold tracking-wider transition-colors relative ${
                  hallwayTab === tab.id ? "text-white" : "text-zinc-600 hover:text-zinc-400"
                }`}
              >
                {tab.label}
                {hallwayTab === tab.id && <div className="absolute -bottom-[9px] left-0 w-full h-px bg-white" />}
              </button>
            ))}
          </div>
                  ...
                  >
                    <div className="flex flex-col gap-2">
                      <div className="flex items-center gap-3 flex-wrap">
                        <span className="text-[10px] font-mono text-zinc-600 bg-zinc-950 px-1 border border-zinc-900">
                          {item.slot_id}
                        </span>
                        ...
                        <div className="flex items-center gap-1.5 px-2 py-0.5 border border-zinc-800 bg-zinc-950">
                          {item.requires_code && !["reviewed", "submitted"].includes(status.type) && (
                            <svg className="w-2.5 h-2.5 text-amber-500" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" clipRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z"/></svg>
                          )}
                    ...
                    <div className="mt-4 md:mt-0">
                      {!isLocked && (
                        <button
                          ...
                          className={`inline-flex items-center h-8 px-6 text-[11px] font-bold border transition-all cursor-pointer ${
                            status.type === "reviewed" ? "border-zinc-800 text-zinc-500 hover:border-zinc-200 hover:text-zinc-200" :
